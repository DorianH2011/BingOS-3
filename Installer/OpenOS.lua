...
do
	local success, result = pcall(component.internet.request, "https://github.com/DorianH2011/BingOS-3/raw/master/Installer/Main.lua")
...
component.eeprom.set([[
	local connection, data, chunk = component.proxy(component.list("internet")()).request("https://github.com/DorianH2011/BingOS-3/raw/master/Installer/Main.lua"), ""
